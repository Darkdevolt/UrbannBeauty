...
(function(){
  ...
  function render(){
    ...
    if(!root) return;
    const links=[
      ['index.html','Accueil','accueil'],['boutique.html','Boutique','boutique'],['boutique.html?cat=visage','Catégories','categories'],['boutique.html?cat=parfums','Nos marques','marques'],['a-propos.html','À propos','apropos'],['contact.html','Contact','contact']
    ];
    root.innerHTML=`
